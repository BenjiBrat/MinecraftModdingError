package com.benjibrat.minecraftplusmod.WorldGen;
...
public class SubWorldGen extends WorldGenerator {
	...
	public boolean generate(World world, Random rand, BlockPos position) {
		...
		Template template = templatemanager.getTemplate(minecraftserver, new ResourceLocation(Reference.MOD_ID+":bigbush"));
